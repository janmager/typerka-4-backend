export const confirmAccountEmailTemplate = (email, email_token, user_id) => {
    ...
    <body>
        <div class="header">
            <h1>⚽ Typerka</h1>
            <p>Gra internetowa do obstawiania wyników meczów piłkarskich</p>
        </div>
        ...
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="${process.env.API_URL}/api/users/confirmAccount?user_id=${user_id}&email_token=${email_token}" class="button">
                    Potwierdź konto
                </a>
            </div>
            ...
            <p style="word-break: break-all; background-color: #e5e7eb; padding: 10px; border-radius: 4px;">
                ${process.env.API_URL}/api/users/confirmAccount?user_id=${user_id}&email_token=${email_token}
            </p>
            ...
            <ul>
                ...
                <li>Obstawiaj dokładne wyniki meczów piłkarskich</li>
...
- Obstawiaj dokładne wyniki meczów piłkarskich
